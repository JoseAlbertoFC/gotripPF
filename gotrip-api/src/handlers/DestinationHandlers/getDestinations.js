const {
  getAllDestinations,
} = require("../../controllers/DestinationControllers/getAllDestinations");
const {
  getDestinationById,
} = require("../../controllers/DestinationControllers/getDestinationById");
const {
  getDestinationByCountry,
} = require("../../controllers/DestinationControllers/getDestinationByCountry");
const {
  getDestinationByCity,
} = require("../../controllers/DestinationControllers/getDestinationByCity");
const getDestinations = async (req, res) => {
  const { country, city } = req.query;
  try {
    const results = country
      ? await getDestinationByCountry(country)
      : city
      ? await getDestinationByCity(city)
